...
println("Running FGMRESSh test for sparse matrices...")
...
println("Running FGMRESSh test for LinearMaps...")
...
# test FGMRESSh with AMG preconditioner for the 
# CG and BiCGStab preconditioner solves
println("Running FGMRESSh AMG test for sparse matrices...")
...
println("Running FGMRESSh Arnoldi decomposition test for sparse matrices...")
